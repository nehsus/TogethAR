package io.agora.agoravideodemo.syncadapter;
...
public class SyncAdapterManager {
    public static final String AUTHORITY    = "io.agora.agoravideodemo.provider";
    public static final String ACCOUNT_TYPE = "io.agora.agoravideodemo";
